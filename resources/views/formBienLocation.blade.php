...
<form method="POST" class="form-a contactForm" action="{{ route('bien_locations.store', ['id_pro' => $id_pro]) }}" enctype="multipart/form-data" style="margin-top: 200px; width: 85%; align-items: center">
@csrf
        ...
        <div class="row">
            ...
            <div class="col-md-12 mb-3">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="piece" id="piece" class="form-control form-control-lg form-control-a" placeholder="Entrez le nombre d'pièces"/>
                    @error('piece')
                        <span class="error-message">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="col-md-12 mb-3">
                <div class="form-group">
                    <label for="prix">Loyer /mois</label>
                    <input type="number" class="form-control" name="loyer" id="loyer" class="form-control form-control-lg form-control-a" placeholder="Entrez votre nom"/>
                    @error('loyer')
                        <span class="error-message">{{ $message }}</span>
                    @enderror
                </div>
...
<div class="row">
    ...
    <div class="col-md-12 mb-3">
        <div class="form-group">
            ...
            <input type="file" class="form-control" name="images[]" multiple id="image" class="form-control form-control-lg form-control-a">
            @error('image')
                <span class="error-message">{{ $message }}</span>
            @enderror
        </div>
