        ...
        <div class="col-md-4">
            <div class="card-box-a card-shadow">
                ...
                @if ($bien_vente->firstImage)
                       <img src="{{ asset($bien_vente->firstImage->path) }}" alt="{{ $bien_vente->title }}" class="img-a img-fluid">
                   @endif
                </div>
            ...
            <div class="card-box-a card-shadow">
                <div class="img-box-a">
                    @if ($bien_location->firstImage)
                       <img src="{{ asset($bien_location->firstImage->path) }}" alt="{{ $bien_location->title }}" class="img-a img-fluid">
                   @endif
                </div>
                <div class="card-overlay">
                    <div class="card-overlay-a-content">
