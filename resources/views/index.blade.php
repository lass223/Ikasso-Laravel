                ...
                <div class="col-lg-8">
                  <div class="intro-body">
                    ...
                    <p class="intro-subtitle intro-price">
                      <a href="{{ url('property-single.blade.php') }}"><span class="price-a">Ajouter un bien </span></a>
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div class="col-lg-8">
                  ...
                  <br> commune IV</p>
                    <h1 class="intro-title mb-4">
                      ...
                      <br> </h1>
                    <p class="intro-subtitle intro-price">
                    <a href="{{ url('login') }}"><span class="price-a">Ajouter un bien</span></a>
            ...
            <div class="card-overlay card-overlay-hover">
              <div class="card-header-d">
                <div class="card-title-d align-self-center">
                  <h3 class="title-d">
                    <a href="#" class="link-two">Standard
                      <br> </a>
                  </h3>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-sm-12 col-md-6">
                <div class="testimonial-img">
                  <img src="{{ url('img/couple.jpg') }}" alt="" class="img-fluid">
                </div>
              </div>
              <div class="col-sm-12 col-md-6">
                ...
                <div class="testimonial-author-box">
                  <img src="{{ url('img/couple.jpg') }}" alt="" class="testimonial-avatar">
        ...
        <div class="carousel-item-a">
          <div class="testimonials-box">
            <div class="row">
              <div class="col-sm-12 col-md-6">
                <div class="testimonial-img">
                  <img src="{{ url('img/couple1.jpg') }}" alt="" class="img-fluid">
                </div>
              </div>
              <div class="col-sm-12 col-md-6">
                <div class="testimonial-ico">
                ...
                <div class="testimonial-author-box">
                  <img src="{{ url('img/couple1.jpg') }}" alt="" class="testimonial-avatar">
