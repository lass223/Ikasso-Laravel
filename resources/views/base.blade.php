...
<body>
  ...
  <div class="box-collapse">
    ...
    <div class="box-collapse-wrap form">
        <form class="form-a" method="GET" action="{{ route('biens.search') }}">
            <div class="row">
  ...
  <nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
    <div class="container">
      ...
      <a class="navbar-brand text-brand" href="{{ url('index') }}">
      ...
      <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link active" href="{{ route('index')}}">Acceuil</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ route('about') }}">À propos</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ route('property-grid') }}">Propriétés</a>
          </li>
          <li class="nav-item">
            <a class="nav-link"href="{{ route('contact') }}">Contact</a>
          </li>
          <li class="nav-item dropdown">
          <a href="{{ route('login') }}"><span class="price-a" style="color: #2eca6a;">Se Connecter</span></a>
          </li>
        </ul>
      </div>
