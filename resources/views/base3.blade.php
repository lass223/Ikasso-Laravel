...
<body>
  ...
  <div class="box-collapse">
    <div class="title-box-d">
        <h3 class="title-d">Recherchez un bien immobilier</h3>
    </div>
    <span class="close-box-collapse right-boxed ion-ios-close"></span>
    <div class="box-collapse-wrap form">
        <form class="form-a" method="GET" action="{{ route('biens.search3') }}">
            <div class="row">
                <div class="col-md-12 mb-2">
                    <div class="form-group">
                        <label for="query">Entrez un quartier ou type de bien</label>
                        <input type="text" name="query" class="form-control form-control-lg form-control-a" placeholder="Mot-clés">
                    </div>
                </div>
                <div class="col-md-12">
                    <button type="submit" class="btn btn-b">Recherchez un bien immobilier</button>
                </div>
            </div>
        </form>
    </div>
  ...
  <nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
    <div class="container">
      ...
      <a class="navbar-brand text-brand" href="{{ url('index3') }}">
      ...
      <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link active" href="{{  route('clie-auth/property-grid3') }}">Acceuil</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ route('clie-auth/about3') }}">À propos</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ route('clie-auth/property-grid3') }}">Propriétés</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link"href="{{ route('clie-auth/contact3') }}">Contact</a>
          </li>
