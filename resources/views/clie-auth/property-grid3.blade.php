      ...
      <div class="row">
        <div class="col-md-12 col-lg-8">
          <div class="title-single-box">
            <h1 class="title-single">Nos magnifiques Propriétés</h1>
                            ...
                            <div class="card-overlay-a-content">
                                <div class="card-header-a">
                                    <h2 class="card-title-a">
                                        <a href="#">{{ $bien_vente->title }}<br /> {{ $bien_vente->adresse }}</a>
                                    </h2>
                                </div>
                                <div class="card-body-a">
                                    ...
                                    <a href="{{ route('bien_vente.show', $bien_vente->id) }}" class="link-a">Plus de détails
                    ...
                    <div class="card-box-a card-shadow">
                        ...
                        <div class="card-overlay">
                            <div class="card-overlay-a-content">
                                <div class="card-header-a">
                                    <h2 class="card-title-a">
                                        <a href="#">{{ $bien_location->title }}<br /> {{ $bien_location->adresse }}</a>
                                    </h2>
                                </div>
                                <div class="card-body-a">
                                    <div class="price-box d-flex">
                                        <span class="price-a">{{ $bien_location->loyer }} Fcfa /MOIS</span>
                                    </div>
                                    <a href="{{ route('bien_location.show', $bien_location->id) }}" class="link-a">Plus de détails
                                        <span class="ion-ios-arrow-forward"></span>
                                    </a>
                                </div>
                                <div class="card-footer-a">
