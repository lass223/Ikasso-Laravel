      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="news-img-box">
            <img src="{{ url('img/slide-3.jpg') }}" alt="" class="img-fluid">
          </div>
        </div>
        ...
        <div class="col-md-10 offset-md-1 col-lg-10 offset-lg-1">
          <div class="title-box-d">
            <h3 class="title-d">Commentaires (4)</h3>
          </div>
          <div class="box-comments">
            <ul class="list-comments">
              <li>
                <div class="comment-avatar">
                  <img src="{{ url('img/author-2.jpg') }}" alt="">
                </div>
              ...
              <li class="comment-children">
                <div class="comment-avatar">
                  <img src="{{ url('img/author-1.jpg') }}" alt="">
                </div>
                <div class="comment-details">
          ...
          <div class="form-comments">
            ...
            <form class="form-a">
              <div class="row">
                ...
                <div class="col-md-6 mb-3">
                  <div class="form-group">
                    <label for="inputEmail1">Entrez votre Email</label>
                ...
                <div class="col-md-12 mb-3">
                  <div class="form-group">
                    <label for="inputUrl">Entrez le site web</label>
                    <input type="url" class="form-control form-control-lg form-control-a" id="inputUrl" placeholder="Website">
                  </div>
                </div>
                <div class="col-md-12 mb-3">
                  <div class="form-group">
                    <label for="textMessage">Écrivez un messge</label>
